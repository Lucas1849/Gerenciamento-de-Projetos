...
- Tests exist in `backend/tests/` (`conftest.py`, `test_smoke.py`, `test_fase5.py`, `test_fase6.py`, `test_fase8.py`, `test_fase9.py` — 26 tests). Run them from `backend/` with `pytest`.
