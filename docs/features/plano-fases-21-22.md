...
- **Cruzamento (crosswalk) verificado: todas as 33 respostas da pesquisa mapeiam para a lista dos 72** — mas **~9 exigem resolução manual de nome** (grafias divergentes): "Andrea van Herk" ↔ "Andrea Costa Van Herk Vasconcelos"; "Mitie Maemura" ↔ "Marcia Mitie Durante Maemura"; "Frederico Vargas" ↔ "Frederico Rafael Vargas Rocha"; "Rafael Guerreiro" ↔ "Rafael Silva Guerreiro"; "CINTIA RODRIGUES DE OLIVEIRA" (caixa alta) ↔ "Cíntia Rodrigues de Oliveira"; "Camila de Araujo"/"Vinicius Silva Pereira" (sem acento); "Rafaela Costa \cruz Barbieri" (typo) ↔ "Rafaela Costa Cruz Barbieri"; espaços à direita em vários. **Decisão de abordagem: resolver o de-para manualmente uma única vez na execução e transcrever o dataset já resolvido no seed — sem fuzzy matching em runtime** (dataset pequeno e estático; mesmo princípio do catálogo, ADR-005: transcrição validada, não inferência).
...
3. **(21) Conflito pesquisa × alinhamento:** ✅ respondida — **"Pesquisa prevalece."**
...
3. **(21) Crosswalk manual:** ~9 nomes resolvidos à mão — um erro de de-para atribui interesses ao professor errado. Mitigar com a tabela de equivalências comentada no próprio seed e conferência por amostragem na verificação.
